...
const Banner = () => {
  ...
  <div className='md:w-3/5 md:text-left sm:text-center'>
      ...
      <p className="py-6 text-lg">There are many variations of passages. Discover the best doctors, clinics & hospitals in the city nearest to you.</p>
      <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg btn-accent">Meet Our Specialist</button>
